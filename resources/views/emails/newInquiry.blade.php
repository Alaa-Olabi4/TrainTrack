...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <p>Hello {{ $username }}</p>
            <p>You have a <strong>new inquiry</strong> waiting for your review.</p>
            <div class="info-box">
                <p>Click the button below to view the full details and respond promptly.</p>
            </div>
            <p style="text-align:center;">
                <a href="{{ $inquiryUrl }}" class="btn">View Inquiry Details</a>
            </p>
