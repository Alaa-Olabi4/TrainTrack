...
<html>
<head>
    <title>Inquiry Follow-Up Reminder</title>
    <style>
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            <h1>Reminder: Follow Up on Your Inquiry</h1>
        </div>
        <div class="content">
            <p>Hello,</p>
            <p>This is a friendly reminder to follow up on your pending inquiry.</p>
            <div class="info-box">
                <p>Our records show that your inquiry is still awaiting your review or response. Please check the details and take any necessary action.</p>
            </div>
            <p style="text-align:center;">
                <a href="{{ $inquiryUrl }}" class="btn">View My Inquiry</a>
            </p>
